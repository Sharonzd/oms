    ...
    link: function(scope, element, attrs, ngModel) {
      ...
      if (datepickerPopupConfig.html5Types[attrs.type]) {
        ...
        attrs.$observe('datepickerPopup', function(value, oldValue) {
            ...
            // FIXME: Refactor when PR is merged: https://github.com/angular-1.2.19/angular-1.2.19.js/pull/10764
...
.provider( '$tooltip', function () {
   ...
   * application.
   *
   *   var app = angular-1.2.19.module( 'App', ['ui.bootstrap.tooltip'], function( $tooltipProvider ) {
